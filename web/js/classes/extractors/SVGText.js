function addSVGTextBehaviour(textFabricObject) {
    ...
    textFabricObject.disconnect = function (refreshCanvas, removeAfterDisconnection) {
        textFabricObject.outConnectors.forEach(function (outConnection) {
        ...
        if (removeAfterDisconnection) {
            setTimeout(function () {
                if (textFabricObject && textFabricObject.canvas) {
                    textFabricObject.remove();
                }
    ...
    textFabricObject.onMouseUp = function (options) {
        ...
        if (textFabricObject.moving) {
            ...
            if (theEvent) {
                ...
                var targetObject = findPotentialDestination(canvasCoords, ['isSVGDataset', 'isVisualProperty', 'isOperator', 'isFunctionInput', 'isAggregator', 'isMark', 'isPlayer', 'isVisualValue', 'isVerticalCollection', 'isMapperInput', 'isMapperOutput', 'isFunctionValuesCollection']);
                ...
                if (targetObject) {
                    ...
                    if (targetObject.isSVGDataset) {
                        ...
                        if (targetObject !== this.parentObject) {
                            ...
                            var visualProperty = targetObject.getDefaultModifiableVisualPropertyByType(connector.value);
