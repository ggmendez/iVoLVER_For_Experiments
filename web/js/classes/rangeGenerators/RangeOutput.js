var RangeOutput = fabric.util.createClass(fabric.Path, {
    ...
    disconnect: function (refreshCanvas, removeAfterDisconnection) {
        var theRangeOutput = this;
        theRangeOutput.outConnectors.forEach(function (outConnection) {
        ...
        if (removeAfterDisconnection) {
            setTimeout(function () {
                if (theRangeOutput && theRangeOutput.canvas) {
                    theRangeOutput.remove();
                }
