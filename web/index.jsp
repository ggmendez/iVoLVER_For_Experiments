...
<html style="overflow-x: no-display;">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="./css/positioner.css" />    
        ...
        <!--<script type="text/javascript" src="./js/canvas-toBlob/canvas-toBlob.js"></script>-->
    ...
    <body oncontextmenu="return false;" onresize="adjustCanvasDimensions();" onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
        ...
        <ul id="theMenu" class="menu nonSelection">
            ...
            <li><a class="description" title="Load Image" href="javascript:void(0);" onclick="onLoad();"><i class="icon-picture fa-2x"></i></a></li>
            <li> <input type="file" accept=".jpeg, .png, .jpg"  id="imageFileInput" name="someFile" onchange="handleImageFiles(this.files, this)" style="visibility:hidden;position:absolute;top:-50;left:-50"/></li>

            <li class="verticalLeftDivider">
                <a class="description" title="Import Photo from Camera" href="javascript:void(0);" onclick="showCameraSignal();"><i id="openCameraButton" class="fa fa-camera fa-2x"></i></a>
            </li>

            <li class="verticalLeftDivider"><a class="description" title="Import SVG File" href="javascript:readSVGFileAsData();"><i class="fa fa-file-code-o fa-2x"></i></a></li>
            <li> <input type="file" accept=".svg" id="dataSVGFileInput" name="someSVGDataFile" onchange="handleSVGFiles(this.files, false, this)" style="visibility:hidden;position:absolute;top:-50;left:-50"/></li>

            <li class="verticalLeftDivider"><a class="description" title="Import CSV / JSON File" href="javascript:loadDatafile();"><i class="icon-table fa-2x"></i></a></li>
            <li> <input type="file" accept=".csv, .json" id="dataimageFileInput" name="someDatafile" onchange="handleDatafiles(this.files, this)" style="visibility:hidden;position:absolute;top:-50;left:-50"/></li>

            <li class="verticalLeftDivider verticalRightDivider verticalRightDivider2"><a class="description" title="Open Web Page" href="javascript:void(0);" onclick="showWebPage();"><i id="openWebPageButton" class="fa fa-globe fa-2x"></i></a></li>

            <!---------->
            <!-- ZOOM -->
            <!---------->
            <li class="description" title="Zoom In" class=""><a href="javascript:zoomIn();" onclick=""><i class="icon-zoom-in fa-2x"></i></a></li>
            <li class="verticalLeftDivider verticalRightDivider verticalRightDivider2"><a class="description" title="Zoom Out" href="javascript:zoomOut();" onclick=""><i class="icon-zoom-out fa-2x"></i></a></li>            
            ...
            <li  class="description" title="Panning Mode" id="panningModeButton" unselectable='on' onselectstart='return false;' onmousedown='modeButtonClicked(this);' draggable="false" class="mode"><a><i class="fa fa-hand-paper-o fa-2x"> </i> </a></li>
            <li class="verticalLeftDivider description" title="Disconnection Mode" id="disconnectingModeButton" unselectable='on' onselectstart='return false;' onmousedown='modeButtonClicked(this);' draggable="false" class="mode"><a><i class="fa fa-unlink fa-2x"> </i> </a></li>

            <li class="verticalLeftDivider verticalRightDivider verticalRightDivider2 description" title="Group Selection Mode" id="squaredSelectionButton" unselectable='on' onselectstart='return false;' onmousedown='modeButtonClicked(this);' draggable="false" class="mode"><a><i class="fa fa-object-group fa-2x"> </i> </a></li>
            ...
            <!--------------------------->
            <li class="verticalLeftDivider verticalRightDivider verticalRightDivider2 description" title="Show / Hide Connections" id="disconnectingModeButton" unselectable='on' onselectstart='return false;' draggable="false" class="mode"><a id="connectorsVisibilityButton" onmousedown="toggleConnectorsVisibility(this);"><i class="fa fa-eye fa-2x"></i></a></li>            
            ...
            <!-- TEXT EXTRACTORS -->
            <!--------------------->
            <!--            <li class=""><a id="lineTextualExtractor" href="javascript:void(0);" onclick="drawTextualExtractor('lineExtractor', this);"><i class="icon-strikethrough fa-2x"></i></a></li>
                        <li class="verticalLeftDivider verticalRightDivider verticalRightDivider2"><a id="blockTextualExtractor" href="javascript:void(0);" onclick="drawTextualExtractor('blockExtractor', this);"><i class="fa fa-stop fa-2x"></i></a></li>-->
            ...
            <li class="mode verticalLeftDivider description" title="Send to Back" unselectable='on' onselectstart='return false;' onmousedown='sendObjectToBack();' draggable="false"><a><i class="fa fa-sort-amount-asc fa-2x clicMenu"> </i> </a></li>
            
            <li class="mode verticalLeftDivider description" title="Show / Hide Connections" unselectable='on' onselectstart='return false;' onmousedown='duplicateObject();' draggable="false"><a><i class="fa fa-clone fa-flip-horizontal fa-2x clicMenu"> </i> </a></li>


            <li class="mode verticalLeftDivider description" title="Expand All Marks" unselectable='on' onselectstart='return false;' onmousedown='expandMarks();' draggable="false"><a><i class="fa fa-angle-double-down fa-2x clicMenu"> </i> </a></li>
            <li class="mode verticalLeftDivider description" title="Compress All Marks" unselectable='on' onselectstart='return false;' onmousedown='compressMarks();' draggable="false"><a><i class="fa fa-angle-double-up fa-2x clicMenu"> </i> </a></li>




            <li class="verticalLeftDivider verticalRightDivider verticalRightDivider2 description" title="Delete Object" unselectable='on' onselectstart='return false;' onmousedown='deleteObject();' draggable="false" class="mode"><a><i class="fa fa-remove fa-2x"> </i> </a></li>





            <li class="verticalLeftDivider verticalRightDivider verticalRightDivider2 description" title="Clear Canvas"><a href="javascript:void(0);" onclick="deleteAllObjects();"><i class="fa fa-trash-o fa-2x"></i></a></li>
                ...
                <ul id="fileMenuUL">
                    ...
                    <li class="divider"><a href="javascript:void(0);"><i class="fa-download icon-large"></i> Export canvas</a>
                        <ul>
                            ...
                            <li><a href="javascript:void(0);" onclick="saveCanvasAsImage();"><i id="saveCanvasElement" class="fa-file-image-o icon-large"></i> As PNG</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <div style="width: 100%" id="mainContainer">
                ...
                <div class="rightPanel nonSelection" id="rightPanel" draggable="false">
                    ...
                    <ul id="extractorsList" class="horizontalButtomsRow">
                        <li title="Multi-color Region" id="groupColorRegionButton" unselectable='on' onselectstart='return false;' onmousedown='modeButtonClicked(this);' draggable="false" class="description boxDivider mode" style="margin-right: 8px; margin-bottom: 6px;"><a><i class="fa fa-paint-brush" style="font-size: 25px;"> </i> </a></li>
                        <li title="Multiple Color Regions" id="multipleColorRegionsButton" unselectable='on' onselectstart='return false;' onmousedown='modeButtonClicked(this);' draggable="false" class="description boxDivider mode" style="margin-right: 8px; margin-bottom: 6px;"><a><i class="fa fa-pencil" style="font-size: 25px;"> </i> </a></li>
                        <li title="Color Region" id="floodFillButton" unselectable='on' onselectstart='return false;' onmousedown='modeButtonClicked(this);' draggable="false" class="description boxDivider mode" style="margin-right: 8px; margin-bottom: 6px;"><a><i class="fa fa-magic" style="font-size: 25px;"> </i> </a></li>
                        <li title="Straight Sampler" id="samplerLineButton" onclick="modeButtonClicked(this);" unselectable='on' onselectstart='return false;' draggable="false" class="description boxDivider mode" style="width: 44%; margin-right: 8px; margin-bottom: 6px;"><a><i class="collections-straightSampler" style="font-size: 22px;"> </i> </a></li>
                        <li title="Sampler" id="samplerButton" onclick="modeButtonClicked(this);" unselectable='on' onselectstart='return false;' draggable="false" class="description boxDivider mode" style="width: 44%; margin-right: 8px; margin-bottom: 6px;"><a><i class="collections-freeSampler" style="font-size: 22px;"> </i> </a></li>
                        <li title="Text Line" id="lineTextExtractorButton" unselectable='on' onselectstart='return false;' onmousedown="modeButtonClicked(this);" draggable="false" class="description boxDivider mode" style="width: 44%; margin-right: 8px;"><a><i class="icon-strikethrough icon-large" style="font-size: 19px;"> </i> </a></li>
                        <li title="Text block" id="blockTextExtractorButton" unselectable='on' onselectstart='return false;' onmousedown="modeButtonClicked(this);" draggable="false" class="description boxDivider mode" style="width: 44%; margin-right: 8px;"><a><i class="fa fa-stop icon-large" style="font-size: 19.5px;"> </i> </a></li>
                    ...
                    <ul id="marksList" class="horizontalButtomsRow">
                        <li id="circlePrototype" draggable="true" title="Circle" class="description dragElement circularBorder" style="margin-right: 15px; margin-bottom: 3px;"><a><i class="mark-circle" style="font-size: 28px;"></i></a></li>
                        <li id="rectPrototype" draggable="true" title="Rectangle" class="description dragElement circularBorder" style="margin-right: 12px; margin-bottom: 3px;"><a><i class="mark-rectangle" style="font-size: 28px;"></i></a></li>
                        <li id="squarePrototype" draggable="true" title="Square"  class="description dragElement circularBorder" style="margin-right: 12px; margin-bottom: 3px;"><a><i class="mark-square" style="font-size: 28px;"></i></a></li>

                        <li id="pathMarkPrototype" draggable="true" title="Path"  class="description dragElement circularBorder" style="margin-right: 15px; margin-bottom: 3px;"><a><i class="mark-pathMark" style="font-size: 28px;"></i></a></li>
                        <li id="fatFontPrototype" draggable="true" title="FatFont"  class="description dragElement circularBorder" style="margin-right: 12px; margin-bottom: 3px;"><a><i class="mark-fatfont" style="font-size: 28px;"></i></a></li>
                        <li id="ellipsePrototype" draggable="true" title="Ellipse"  class="description dragElement circularBorder" style="margin-right: 12px; margin-bottom: 3px;"><a><i class="mark-ellipse" style="font-size: 28px;"></i></a></li>
                        ...
                        <li id="filePrototype" draggable="false" title="From SVG File"  class="description dragElement boxDivider" style="margin-right: 6px; margin-bottom: 0px;"><a onclick="loadSVGFile();"><i class="mark-svg"></i></a></li>                        
                        <li id="drawFilledMark" title="Draw Path Mark"  onclick="modeButtonClicked(this);" unselectable='on' onselectstart='return false;' draggable="false" class="description boxDivider mode" style="margin-right: 5px; margin-bottom: 0px;"><a><i class="mark-filled"> </i> </a></li>
                        <li id="drawPathMark" title="Draw Filled Mark"  onclick="modeButtonClicked(this);" unselectable='on' onselectstart='return false;' draggable="false" class="description boxDivider mode" style="margin-right: 5px; margin-bottom: 0px;"><a><i class="mark-path"> </i> </a></li>
                    </ul>
                    <hr />
                    ...
                    <ul id="datatypesList" class="horizontalButtomsRow">
                        <li id="isShapeData" draggable="true" title="Shape" class="description dragElement circularBorder" style="margin-right: 1px; margin-bottom: 5px;"><a><i class="value-shape" style="font-size: 25px;"> </i> </a></li>
                        <li id="isColorData" draggable="true" title="Color"  class="description dragElement circularBorder" style="margin-right: 1px; margin-bottom: 5px;"><a><i class="value-color" style="font-size: 25px;"></i></a></li>
                        <li id="isStringData" draggable="true" title="Text"  class="description dragElement circularBorder" style="margin-right: 1px; margin-bottom: 5px;"><a><i class="value-string" style="font-size: 25px;"></i></a></li>
                        <li id="isNumericData" draggable="true" title="Number"  class="description dragElement circularBorder" style="margin-right: 1px; margin-bottom: 5px;"><a><i class="value-number" style="font-size: 25px;"></i></a></li>
                        <li id="rangeGenerator" draggable="true" title="Range of Values"  class="description dragElement circularBorder" style="margin-right: 10px; margin-bottom: 0px;"><a style="padding-top: 6px; padding-left: 10px; padding-bottom: 0px;"><i class="range-generator" style="font-size: 24px;"></i></a></li> 
                        <li id="isDurationData" draggable="true" title="Duration"  class="description dragElement circularBorder" style="margin-right: 1px; margin-bottom: 0px;"><a><i class="value-duration" style="font-size: 25px;"> </i> </a></li>
                        <li id="isDateAndTimeData" draggable="true" title="Date & Time"  class="description dragElement circularBorder" style="margin-right: 1px; margin-bottom: 0px;"><a><i class="value-dateAndTime" style="font-size: 25px;"></i></i></a></li>
                    </ul>
                    <hr />
                    ...
                    <ul id="operatorsList" class="horizontalButtomsRow">
                        <li id="division-operator" draggable="true" title="Division" class="description dragElement circularBorder" style="margin-right: 1px;"><a><i class="operator-divisonIcon" style="font-size: 24px;"></i></a></li>
                        <li id="multiplication-operator" draggable="true" title="Multiplication" class="description dragElement circularBorder" style="margin-right: 2px;"><a><i class="operator-multiplicationIcon" style="font-size: 24px;"></i></a></li>
                        <li id="subtraction-operator" draggable="true" title="Subtraction" class="description dragElement circularBorder" style="margin-right: 2px;"><a><i class="operator-subtractionIcon" style="font-size: 24px;"></i></a></li>
                        <li id="addition-operator" draggable="true" title="Addition" class="description dragElement circularBorder" style="margin-right: 2px;"><a><i class="operator-additionIcon" style="font-size: 24px;"></i></a></li>
                    </ul>
                    <hr />
                    ...
                    <ul id="draggableWidgetsList" class="horizontalButtomsRow">
                        <li title="Generator" id="collectionGenerator" draggable="true" class="description dragElement circularBorder" style="margin-right: 0px; margin-bottom: 0px;"><a><i class="collections-generator"></i></a></li>
                        <li title="Mapper" id="mapperWidget" draggable="true" class="description dragElement circularBorder" style="margin-right: 0px; margin-bottom: 0px;"><a><i class="collections-mapper"></i></a></li>
                        <li title="Collection" id="verticalCollection" draggable="true" class="description dragElement circularBorder" style="margin-right: 0px; margin-bottom: 0px;"><a><i class="collections-collection" ></i></a></li>
                    </ul>
                    <hr />

                    <!-- POSITIONERS -->
                    <h6 id="functionsListH6" onclick="togglePanelVisibility('#locatorsList', false);" style="cursor: pointer;" class="nonSelection sectionHeader"><span class="fa fa-angle-down" style="margin-right: 5px;"></span>Positioners</h6>
                    <ul id='locatorsList' class="horizontalButtomsRow">
                        <li id="locatorWidget" draggable="true" title="Positioner" class="description dragElement circularBorder" style="margin-right: 0px; margin-bottom: 6px;"><a><i class="positioner-positioner" style="font-size: 25px;"></i></a></li>
                    ...
                    <ul id='functionsList' class="horizontalButtomsRow">
                        <li title="x Squared" id="x2Function" draggable="true" class="description dragElement circularBorder" style="margin-right: 3px; margin-bottom: 6px;"><a><i class="function-x2"></i></a></li>
                        <li title="x" id="xFunction" draggable="true" class="description dragElement circularBorder" style="margin-right: 0px; margin-bottom: 6px;"><a><i class="function-x"></i></a></li>
                        <li title="Emtpy Function" id="emptyFunction" draggable="true" class="description dragElement circularBorder" style="margin-right: 0px; margin-bottom: 6px;"><a><i class="function-empty"></i></a></li>
                        

                        <li title="log(x)" id="logXFunction" draggable="true" class="description dragElement circularBorder" style="margin-right: 3px; margin-bottom: 6px;"><a><i class="function-logx"></i></a></li>
                        <li title="cos(x)" id="cosXFunction" draggable="true" class="description dragElement circularBorder" style="margin-right: 0px; margin-bottom: 6px;"><a><i class="function-cosx"></i></a></li>
                        <li title="sin(x)" id="sinXFunction" draggable="true" class="description dragElement circularBorder" style="margin-right: 0px; margin-bottom: 6px;"><a><i class="function-sinx"></i></a></li>
                        <li title="x Cubic" id="x3Function" draggable="true" class="description dragElement circularBorder" style="margin-right: 0px; margin-bottom: 6px;"><a><i class="function-x3"></i></a></li>

                        <li title="Enter" id="enterFunction" onclick="enterFunctionButtonClicked();" unselectable='on' onselectstart='return false;' draggable="false" class="description boxDivider" style="width: 30%;"><a><i class="fa-superscript icon-large" style="font-size: 22.5px;"> </i> </a></li>
                        <li title="Draw" id="drawFunction" onclick="modeButtonClicked(this);" unselectable='on' onselectstart='return false;' draggable="false" class="description boxDivider mode" style="width: 30%; margin-right: 10px;"><a><i class="function-draw"> </i> </a></li>
                        <li title="sqrt(x)" id="sqrtXFunction" draggable="true" class="description dragElement circularBorder" style="margin-right: 10px;"><a><i class="function-sqrtx"></i></a></li>
                    </ul>
...
//            deactivateScribbleMode();
            ...
            // Creating a number //
            ///////////////////////
            /*var numberVisualValue = createDefaultVisualValueByTypeProposition("isNumericData", 400, 250);
             canvas.add(numberVisualValue);
             numberVisualValue.animateBirth(false, null, null, false);*/

            //////////////////////////////
            // Creating a date and time //
            //////////////////////////////
            /*var dateAndTimeVisualValue1 = createDefaultVisualValueByTypeProposition("isDateAndTimeData", 500, 500);
             canvas.add(dateAndTimeVisualValue1);
             dateAndTimeVisualValue1.animateBirth(false, null, null, false);*/
            //////////////////////////////
            // Creating a date and time //
            //////////////////////////////
            /*var dateAndTimeVisualValue2 = createDefaultVisualValueByTypeProposition("isDateAndTimeData", 600, 500);
             canvas.add(dateAndTimeVisualValue2);
             dateAndTimeVisualValue2.animateBirth(false, null, null, false);*/
            /////////////////////////
            // Creating a duration //
            /////////////////////////
            /*var durationVisualValue = createDefaultVisualValueByTypeProposition("isDurationData", 700, 450);
             canvas.add(durationVisualValue);
             durationVisualValue.animateBirth(false, null, null, false);*/
...
//             addNumericFunction(500, 300, coordinates.XCoordinates, coordinates.YCoordinates);
            ...
            /*var numericValue = createNumericValue(80);
             ...
             var numberVisualValue = CreateVisualValueFromValue(numericValue);
             
             numberVisualValue.left= 100;
             numberVisualValue.top = 200;
...
//            canvas.renderAll();
            ...
            /*addRange({left: 800, top: 500});
             ...
             togglePanelVisibility('#extractorsList', false);
             togglePanelVisibility('#draggableWidgetsList', false);
             togglePanelVisibility('#functionsList', false);
