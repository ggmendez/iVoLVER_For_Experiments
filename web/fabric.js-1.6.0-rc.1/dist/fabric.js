        ...
        if (root.Gesture && root.Gesture._gestureHandlers[type]) { // Fire custom event.
            ...
            for (var n = 0, eventId; n < eventList.length; n++) {
                ...
                if (trigger === "remove") { // Remove event listener.
                    ...
                    if (wrappers[eventId])
                        return wrappers[eventId]; // Already attached.
...
//			bbox.scrollLeft += document.body.scrollLeft;
    ...
    (function () {
        ...
        root.metaTracker = function (event) {
            ...
            if (event.keyCode === 27)
                eventjs.escKey = root.escKey = isKeyDown;
            if (metaKeys[event.keyCode])
                eventjs.metaKey = root.metaKey = isKeyDown;
            ...
            if (root.pointerEnd(event, self, conf)) {
                ...
                if (x > bbox.x1 && y > bbox.y1 &&
                    ...
                    for (var key in conf.tracker)
                        break; //- should be modularized? in dblclick too
    ...
    fabric.StaticCanvas = fabric.util.createClass(/** @lends fabric.StaticCanvas.prototype */ {
        ...
        _setSVGObjects: function (markup, reviver) {
            for (var i = 0, objects = this.getObjects(), len = objects.length; i < len; i++) {
                ...
                if (objects[i].toSVG) { // MODIFICATION BY GONZALO (I have implemented objects which no toSVG methods
...
//            }
            ...
            if (!this.visible) { // MODIFICATION BY GONZALO
                return;
            }
...
//            }
            ...
            if (this.strokeDashArray) {
                ...
                if (this.stroke && this.stroke.gradientTransform) { // MODIFICATION BY GONZALO
...
(function (global) {
    ...
    fabric.Circle = fabric.util.createClass(fabric.Object, /** @lends fabric.Circle.prototype */ {
        ...
        _render: function (ctx, noTransform) {
            ...
            // modification by GONZALO: checking if the given radius is negative
            if (this.radius >= 0) {
